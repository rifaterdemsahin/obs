...
| 2.4 | Absolute paths are remapped during restore | ⬜ Not Built | Restore script not yet implemented |
...
| 3.4 | Custom plugins are version-controlled | ✅ Pass | `plugins/projector-hotkeys.lua` committed |
| 3.5 | Restore script pushes config back | ⬜ Not Built | Future work |
...
| Reproducibility | 4 | 0 | 4 (needs second machine) |
| Plugin management | 1 | 1 | 0 |
| **Total** | **10** | **6** | **4** |

**Conclusion:** Core IaC backup pipeline is working. Restore and cross-machine portability remain as future work items tracked in [`2_Environment`](../2_Environment/README.md) roadmap.
